...
void ClothSimulator::load_textures() {
  ...
  glGenTextures(1, &m_gl_cubemap_tex0);
  ...
  m_gl_texture_7_size = load_texture(7, m_gl_texture_7, (m_project_root + "/textures/texture_7.png").c_str());
  ...
  std::vector<std::string> cubemap_fnames = {
    m_project_root + "/textures/cube/posx2.jpg",
    m_project_root + "/textures/cube/negx2.jpg",
    m_project_root + "/textures/cube/posy2.jpg",
    m_project_root + "/textures/cube/negy2.jpg",
    m_project_root + "/textures/cube/posz2.jpg",
    m_project_root + "/textures/cube/negz2.jpg"
  };
  
  load_cubemap(8, m_gl_cubemap_tex0, cubemap_fnames);
...
void ClothSimulator::drawContents() {
  ...
  case PHONG:
    ...
    shader.setUniform("u_texture_cubemap", 8, false);
    drawPhong(shader);
    break;
  }
